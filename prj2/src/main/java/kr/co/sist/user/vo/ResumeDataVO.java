 ...
 * 2023-04-21 확인
 * 경태
 * 이력서수정 page 에서 회원/이력서 Table 
 * select
 * @author 경태
 *
 */
public class ResumeDataVO {
	...
	public ResumeDataVO(String name, String email, String tel, String addr, String img, String gender, Date birthDate,
