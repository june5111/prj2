	...
	<div id="container">
		<div id="content">
			...
			<div class="mbrSec mbrSchIDResult">
				<h2 class="mbrHeading2"><img src="http://localhost/prj3/project_user/3.idPass/images/mbr_h_msch_id_2.gif" alt="아이디조회"></h2>
				...
				<p class="mbrBtnFunc"><span class="mbrBtn mbrBtnLogin_1"><a href="http://localhost/prj3/project_user/2.join/login.jsp">로그인</a></span> <span class="mbrBtn mbrBtnSearch_2"><a href="http://localhost/prj3/project_user/3.idPass/findPw.jsp">비밀번호 찾기</a></span></p>
			</div>
			<hr>
		</div>
		<hr>
