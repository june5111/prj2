...
<div id="header">
	<div class="gnbWrap gnbWrap_mMng">
		...
		<div id="gnb">
			...
			<span class="bar"><span class="title"><img src="http://localhost/prj3/project_user/images/h_mng_gg.gif" alt="회원정보 관리"></span></span>
			</h1>
<!--skip은 안보임  -->	<h2 class="skip"><!--주요링크--></h2>
			<ul class="lnb">
				<li><a href="http://localhost/prj3/project_user/1.main/main_page.jsp">개인회원 홈</a></li>
			</ul>
			<!-- <br><br><br> -->
			<div class="secNav">
				<ol>
					<li class="mn1"><a href=""><span class="span"></span>개인정보 수정</a></li>
					<li class="mn2"><a href="http://localhost/prj3/project_user/5.memberInfo/3.confirmPass.jsp"><span></span>비밀번호변경</a></li>
...
<div id="wrap">
	...
	<div id="container">
		<div id="content">
			<form id="con_frm" name="con_frm" method="post" action="http://localhost/prj3/project_user/5.memberInfo/confirmInfo_process.jsp">
<!--skip은 안보임  -->	<h1 class="skip"><!--비밀번호 확인--></h1>
			<fieldset>
				<!-- <legend>비밀번호 확인 정보 입력폼</legend> -->
				<div class="mbrSec mbrMngPWD">
					<h2 class="mbrHeading2"><img src="http://localhost/prj3/project_user/images/mbr_h_mng_pwd.gif" alt="비밀번호 확인"></h2>
...
<!--skip은 안보임  -->		<caption><span class="skip"><!-- 비밀번호 확인 입력폼 --></span></caption>
				...
				<p class="mbrBtnFunc">
					...
					<span class="mbrBtn mbrBtnCancel_1"><button type="button" onclick="location.href='http://localhost/prj3/project_user/1.main/main_page_loged.jsp'"><span>취소</span></button></span>
				</p>
			</fieldset>
			</form>
		</div>
